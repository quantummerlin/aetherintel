(function () {
  ...
  s.textContent = [
    '#aether-footer{background:#07070f;border-top:1px solid rgba(129,140,248,0.15);padding:32px 24px 28px;margin-top:0;font-family:"Space Grotesk",-apple-system,BlinkMacSystemFont,sans-serif;text-align:center;}',
    '.af-inner{max-width:780px;margin:0 auto;}',
    '.af-top{display:flex;flex-direction:column;align-items:center;gap:16px;flex-wrap:wrap;margin-bottom:20px;}',
    '.af-brand{text-align:center;}',
    ...
    '.af-tagline{font-size:.8rem;color:rgba(148,163,184,0.7);line-height:1.55;max-width:320px;margin:0 auto;}',
    '.af-bmc-wrap{display:flex;align-items:center;justify-content:center;}',
    ...
    '.af-bottom{display:flex;align-items:center;justify-content:center;gap:16px;flex-wrap:wrap;}',
    '.af-copy{font-size:.76rem;color:rgba(148,163,184,0.4);margin:0;}',
    '.af-links{display:flex;gap:20px;flex-wrap:wrap;justify-content:center;}',
    ...
    '@media(max-width:520px){.af-bottom{flex-direction:column;align-items:center;gap:10px;}}'
  ].join('');
