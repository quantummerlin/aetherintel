(function () {
  ...
  s.textContent = [
    ...
    '.af-logo{font-family:"Orbitron",sans-serif;font-size:1.1rem;font-weight:800;background:linear-gradient(135deg,#6274f5,#1dd3f1);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;text-decoration:none;letter-spacing:.04em;display:inline-block;margin-bottom:8px;}',
